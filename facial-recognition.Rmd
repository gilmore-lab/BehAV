...
select snap region
- this will allow you to code in the MomAngle column just during the MomHead sections

For the first cell in the column 
- Highlight the 'MomAngle' heading
...
### Value List
https://www.researchgate.net/figure/The-head-pose-rotation-angles-Yaw-is-the-rotation-around-the-Y-axis-Pitch-around-the_fig1_281587953

L/R values (rotation about y-axis - Yaw)
...
U/D values (rotation about x-axis - Pitch)
